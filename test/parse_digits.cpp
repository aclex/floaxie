...
bool check_integer()
{
	...
	dp = parse_digits<decimal_q<double>, false, double>(str1);
	...
	dp = parse_digits<decimal_q<double>, false, double>(str2);
	std::cout << "value: " << dp.value << std::endl;
	std::cout << "sign: " << dp.sign << std::endl;
	std::cout << "K: " << dp.K << std::endl;
...
bool check_decimal_fraction()
{
	...
	dp = parse_digits<decimal_q<double>, false, double>(str0);
	...
	dp = parse_digits<decimal_q<double>, false, double>(str3);
	std::cout << "value: " << dp.value << std::endl;
	std::cout << "sign: " << dp.sign << std::endl;
	std::cout << "K: " << dp.K << std::endl;
